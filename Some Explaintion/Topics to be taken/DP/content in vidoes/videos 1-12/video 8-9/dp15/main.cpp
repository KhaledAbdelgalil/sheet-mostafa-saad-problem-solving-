//building dp :: you have min operations is 2 but now what are the operations you need to build it
//problem :: 526-String Distance and Transform Processs(left for now)
